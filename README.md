...
How to create a custom-shaped bitmap marker with Android map API <br />
This is sample project to create a custom marker with images(from URL) on android using google map API.<br /><br />
